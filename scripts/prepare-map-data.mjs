...
const DATASETS = [
  ...
  {
    input: "data/catalog-export-20260813105355.json",
    output: "pskov-points.geojson",
    useFilenames: false,
  },
  {
    input: "data/catalog-export-20260813110256.json",
    output: "lithuania-points.geojson",
    useFilenames: false,
  },
  {
    input: "data/catalog-export-20260813110816.json",
  ...
  {
    input: "data/catalog-export-20260813115722.json",
    output: "poland-points.geojson",
    useFilenames: false,
  },
];
