...
export const CAMERA_ICON_ID = "archive-camera";

const CAMERA_ICON_SVG = `
<svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="15" height="15" viewBox="0 0 32 32" aria-hidden="true">
...
export async function addCameraIcon(map: Map): Promise<void> {
  ...
  if (!map.hasImage(CAMERA_ICON_ID)) {
    map.addImage(CAMERA_ICON_ID, image, { pixelRatio: 2 });
  }
}
