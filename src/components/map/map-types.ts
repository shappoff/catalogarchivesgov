...
/** Bounding box covering all Ukraine archive points [west, south, east, north]. */
export const UKRAINE_BOUNDS: [[number, number], [number, number]] = [
  [23.69, 47.54],
  [36.25, 51.21],
];

/** Bounding box covering all Poland archive points [west, south, east, north]. */
...
export const ARCHIVE_REGIONS: Record<ArchiveRegionId, ArchiveRegion> = {
  ...
  ukraine: {
    ...
    path: "/ukraine",
    label: "Украина",
    dataFile: "ukraine-points.geojson",
  ...
  poland: {
    ...
    path: "/poland",
    label: "Польша",
    dataFile: "poland-points.geojson",
